            ...
            <div class="header__wrapper">
              ...
              <div class="header__account account account--has-login" >
                  <div class="account__wrapper" >
                    <img class="account__img" src="{{ asset('css/2.jpg') }}" />
                    <span class="account__name" style="color:white;font-size:15px"><b>test</b></span>
                  </div>
        ...
        <main role="main" class="site__main main"  >
          ...
          <nav class="main__nav nav"  >
            ...
            <ul class="nav__wrapper" >
             ...
             <li class="nav__item nav__item--has-child">
                <a href="#">
                  <i class="glyphicon glyphicon-user" style="font-size:18px;color:white"></i> Leave Management
                  <i class="nav__arrow fa fa-angle-down"></i>
                </a>
                ...
                <ul class="nav__wrapper nav__wrapper--child">
                  ...
                  <ul class="nav__wrapper nav__wrapper--child">
                    <li class="nav__item--child"><a href="http://127.0.0.1:8000/approvedleave">Aproved Leaves</a></li>
              ...
              <li class="nav__item"><a href="http://127.0.0.1:8000/users">

                <i class="fas fa-book-dead" style="font-size:18px;color:white"></i> Login Requests </a>
              </li>
              ...
              <li class="nav__item nav__item--has-child">
                <a href="#">
                  <i class="glyphicon glyphicon-user" style="font-size:18px;color:white"></i> Apply For Leaves
                  <i class="nav__arrow fa fa-angle-down "> </i>
                </a>
              ...
              <li class="nav__item"><a href="http://127.0.0.1:8000/index">
                <i  class="far fa-paper-plane" style="font-size:18px;color:white"></i> Requests</a>
              </li>
              <li class="nav__item"><a href="http://127.0.0.1:8000/index">
                <i  class="far fa-paper-plane" style="font-size:18px;color:white"></i> Elegibility</a>
              </li>
              <li class="nav__item"><a href="http://127.0.0.1:8000/allleave">
                <i class="nav__icon fa fa-edit" style="font-size:18px;color:white" ></i> Confirmations</a>
              </li>
              <li class="nav__item"><a href="http://127.0.0.1:8000/contact/create">
                <i class="nav__icon fa fa-edit" style="font-size:18px;color:white" ></i>Job Specification</a>
              </li>

              <li class="nav__item nav__item--has-child">
                <a href="#">
                  <i class="glyphicon glyphicon-user" style="font-size:18px;color:white"></i> Manage Requirments
                  <i class="nav__arrow fa fa-angle-down "> </i>
                </a>

                <ul class="nav__wrapper nav__wrapper--child">
                  <li class="nav__item--child"><a href="http://127.0.0.1:8000/requirment">View Requirments</a></li>

                </ul>
                <ul class="nav__wrapper nav__wrapper--child">
                    <li class="nav__item--child"><a href="http://127.0.0.1:8000/requirment/create">Add Requirments</a></li>
